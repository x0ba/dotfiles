...
;;
;;
(setq doom-font (font-spec :family "JetBrains Mono" :size (if (eq system-type 'darwin) 12 14))
      doom-variable-pitch-font (font-spec :family "Inter" :size (if (eq system-type 'darwin) 12 14)))
